    ...
    try {
      ...
      if (result.error) {
        ...
        if (confirmResult.success) {
          // 🟢 CAMBIO 1: Mostrar notificación antes de cambiar de step
          ...
          // 🟢 CAMBIO 2: Retrasar el callback de éxito para que el toast sea visible
          setTimeout(() => {
...
export default function StripeCheckout({ isOpen, onClose, onSuccess }) {
  ...
  return (
    <div className="w-full p-4">
      {/* 🟢 CAMBIO 3: ToastContainer movido fuera y con configuración específica */}
      <ToastContainer
        position="top-right"
        autoClose={5000}
        hideProgressBar={false}
      ...
      <Elements stripe={stripePromise}>
        <CheckoutForm
          onSuccess={(orden) => {
            // 🟢 CAMBIO 4: No cerrar inmediatamente, solo pasar el callback
            onSuccess(orden);
            // El cierre ahora se maneja desde el botón en la pantalla de éxito
          }}
